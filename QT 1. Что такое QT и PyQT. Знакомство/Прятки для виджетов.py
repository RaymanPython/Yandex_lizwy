...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        self.cb1.move(5, 10)
        self.cb1.stateChanged.connect(self.func(self.name_input1))
        self.name_input1.move(65, 10)

        self.cb2.move(5, 40)
        self.cb2.stateChanged.connect(self.func(self.name_input2))
        self.name_input2.move(65, 40)

        self.cb3.move(5, 70)
        self.cb3.stateChanged.connect(self.func(self.name_input3))
        self.name_input3.move(65, 70)

        self.cb4.move(5, 100)
        self.cb4.stateChanged.connect(self.func(self.name_input4))
